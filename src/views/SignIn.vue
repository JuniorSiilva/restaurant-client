<template>
  <q-page class="bg-light-green-8 window-height window-width row justify-center items-center">
    <div class="column">
      <div class="row">
          ...
          <ValidationObserver v-slot="{ passes }" ref="form" slim>
            <q-form @submit.prevent="passes(handle)">
              <q-card-section>
                ...
                <ValidationProvider ref="username" v-slot="{ errors }" name="email" rules="required|email">
                  <q-input
